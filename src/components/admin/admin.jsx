  ...
  return (
    <>
        ...
        <div className='bg-slate-200 h-screen w-full'>
            ...
            <div className="">
                <div className='flex flex-col  lg:w-full lg:flex-row  justify-center  gap-4'>
                    <Form uri={`${API_URL}order`} name={'order'} />
                    <Form uri={`${API_URL}form`} name={'contact'} />
                </div>
            </div>
                            ...
                            <tbody>
                                {data.map((i) => (
                                  <tr key={i._id} className="text-center">
                                        ...
                                        <td className="border p-2">{i.budget}</td>
