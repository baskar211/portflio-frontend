      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/" className="text-xl font-bold text-gray-900 dark:text-purple-400 dark:hover:text-blue-400 ">
              Baskar Portfolio
            </Link>
          </div>
          ...
          >
            <div className="w-6 h-6 flex flex-col justify-center gap-1">
              <div
                className={`w-full h-0.5 bg-gray-900 dark:bg-purple-700 transition-all duration-300 ${
